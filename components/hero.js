    ...
    <div>
      <Container className="flex flex-wrap mb-20 lg:mt-20 ">
          ...
          <div className="max-w-2xl mb-8">
            ...
            <div className="flex flex-col items-start space-y-3 sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row">
              <a
                ...
                target="_blank"
                rel="noopener"
                className="px-8 py-4 text-lg font-medium text-center text-white-50 bg-primary-50 rounded-md transform transition shadow-[rgba(0,_0,_0,_0.25)_0px_25px_50px_-12px] duration-500"
              >
                View my projects
              </a>
        ...
        <div className="flex items-center justify-center w-full lg:w-1/2">
          <div className="">
            <Image src={HeroImg} width="500" height="500" className={"object-cover"} alt="Hero Illustration" loading="eager" />
          </div>
        </div>
      </Container>
    </div>
